...
public class EveryTeam {
	...
	public int player7Id;
	public int player8Id;
	public int player9Id;
	public int player10Id;
	public int player11Id;
	...
	public int getPlayer11Id() {
		return player11Id;
	}
	public void setPlayer11Id(int player11Id) {
	...
	public String toString() {
		return "EveryTeam [teamId=" + teamId + ", formation=" + formation + ", player1Id=" + player1Id + ", player2Id="
				+ player2Id + ", player3Id=" + player3Id + ", player4Id=" + player4Id + ", player5Id=" + player5Id
				+ ", player6Id=" + player6Id + ", player7Id=" + player7Id + ", player8Id=" + player8Id + ", player9Id="
				+ player9Id + ", player10Id=" + player10Id + ", player11Id=" + player11Id + ", usersId=" + usersId
				+ "]";
	}
