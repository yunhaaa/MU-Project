...
<body class="background-image"
	...
	<div>
		...
		<div style="text-align: center; margin-top: 20px;">
			<p style="color: rgb(255, 255, 255); font-size: 50px;">게시판</p>
		</div>
		...
		<div style="background-color: rgb(200, 200, 200);">
			...
			<div style="text-align: center;">
				...
				<h5>
					<input type="text" name="article" value="${board.article}"
						style="width: 800px;">
				</h5>

			</div>
			<div style="text-align: center;">작성자 : ${board.usersId}</div>
		</div>
		...
		<div style="text-align: center; margin-top: 20px;">
			...
			<p style="color: rgb(255, 255, 255)">${board.usersId}님의스쿼드입니다.</p>
		</div>
		...
		<div style="opacity: 0.90;">
			<div class="row">
				...
				<div class="col-8">
					...
					<!--  
					<div style="text-align: center; margin-top: 20px;">
						<a href="board.do" class="btn btn-primary" id="mubtn">게시판 목록으로</a>
					</div>
					-->
				</div>
			</div>
			...
			<c:forEach var="cm" items="${comments}">
				<div style="text-align: center;">
					<div style="background-color: rgb(200, 200, 200);">
						<div style="text-align: center;">
							<p class="card-text"
								style="background-color: #333; color: white; /* 텍스트의 색상을 흰색으로 변경 */ font-size: 16px;">댓글
								작성자</p>
							<p class="card-text">

								<input type="text" name="boardTitle" value="${cm.usersNickName}">
							</p>
						</div>
						<div style="text-align: center;">
							<h5
								...
								내용</h5>
							<h5>
								<input type="text" name="article" value="${cm.commentText}"
									style="width: 800px;">
							</h5>
...
<div style="margin-top:25px;">
		<form method="post"
			action="boardArticleComments.do?boardId=${board.boardId}">
			<input type="hidden" name="boardBoardId" value="${board.boardId}">
			<input type="hidden" name="nickname"
				value="<%=session.getAttribute("nickname")%>">
			<div style="background-color: rgb(200, 200, 200);">
				<div style="text-align: center;">
					<p class="card-text"
						style="background-color: #333; color: white; /* 텍스트의 색상을 흰색으로 변경 */ font-size: 16px;">댓글 달기 (닉네임) : <%=session.getAttribute("nickname")%></p>
					<p class="card-text">
						<input type="text" name="commentText" id="commentText"
							style="width: 500px;">
						<button type="submit" id="mubtn" id="commentButton"
